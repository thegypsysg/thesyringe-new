                  ...
                  <!-- <v-form fast-fail @submit.prevent="login"> -->
                    ...
                    <div class="w-75 mb-16 mb-md-8 d-flex align-center">
                      ...
                      >
                        <span
                          class="fi ml-2 pr-4 mr-4"
                          :class="['fi-' + nationality.toLowerCase()]"
                        />
                      </div>
                      <MazSelect
                        v-slot="{ option }"
                        ...
                        size="md"
                        class="w-100"
                        search-placeholder="Search in nationality"
                        :class="{ 'ml-n1': nationality }"
                      >
                        <div
                          class="flex items-center"
                          style="
...
export default {
  ...
  { phoneNum: "+44", value: "GB-SCT", label: "Scotland" },
  ...
  watch: {
    ...
    nationality: function (newVal, oldVal) {
      ...
      this.nationalityCode = nationality?.phoneNum;
    },
  },
  created() {
  ...
  methods: {
    saveData() {
      const payload = {
        ...
        born_country_code: this.countryCode,
        ...
        nationality_country_code: this.nationalityCode,
