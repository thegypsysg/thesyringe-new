            ...
            >
              <v-row>
                <v-col cols="12">
                  ...
                  <div
                    style="height: 0.5px; background: black"
                    class="w-100 my-2"
                  ></div>
                </v-col>
                <v-col class="pb-16 pb-md-10" :cols="isSmall ? '12' : '4'">
                  <!-- <h1
                    class="mb-4"
                  ...
                  <div class="d-flex align-center mt-2">
                    <input
                      ...
                      @input="onDateInput"
                    />
                    <span v-if="age" class="font-weight-bold ml-2 w-33"
                      ><span class="text-red">{{ age }}</span> Years</span
                    >
                  </div>
  ...
  methods: {
    ...
    saveData() {
      ...
      if (this.date && this.marital) {
        axios
          .post(
            `/gypsy-applicant/save-date-of-birth-and-marital-status`,
            payload,
            {
              headers: {
