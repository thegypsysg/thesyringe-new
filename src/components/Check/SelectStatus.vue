            ...
            >
              ...
              <!-- <div style="height: 0.5px; background: black;" class="w-100 my-2"></div> -->
                ...
                <v-col :cols="isSmall ? '12' : '10'">
                  ...
                  <br /> -->
                  <h2>You are Applying for a</h2>
                  <br />
                  <h2><span class="text-blue-accent-4">{{skillsName}}</span> Job in <span class="text-red">{{countryName}}</span></h2>
                  <br />
                  <h2>Your Basic Qualifications (Bachelor's Degree) must be Registrable with <span class="text-blue-accent-4">{{regulatorName}}</span></h2>
                  <br />
                  <h2>Please press Next to check if you are eligible to make this Application.</h2>
                  <div
                  class="d-flex align-center"
  ...
  methods: {
    getData() {
      ...
      .then((response) => {
        ...
        this.skillsName = data.skills_name;
