...
export default {
  ...
  mounted() {
    ...
    this.qualificationType = localStorage.getItem("qualification_type") ? localStorage.getItem("qualification_type") : this.resource.skills1.filter(sk => sk.value == this.qtId)[0].label;
  },
  unmounted() {
